...
<body>
    ...
    <header>
        ...
        <ul class="navigation">
            ...
            <li><a href="jerseys.html" id="active">Jerseys</a></li>
    ...
    <main>
        <div class="products">
            ...
            <div class="boxes">
                ...
                <div class="box">
                    <img src="images/tott.png">

                    <div class="product-desc">
                        <div class="emri-cmimi">
                            <p class="name">Tottenham Third Kit 21/22</p>
                ...
                <div class="box">
                    <img src="images/liv2.png">
                    <div class="product-desc">
                        <div class="emri-cmimi">
                            <p class="name">Liverpool Away Kit 21/22</p>
                            <p class="price">$89.99</p>
            ...
            <div class="boxes">
                ...
                <div class="box">
                    ...
                    <div class="product-desc">
                        <div class="emri-cmimi">
                            <p class="name">Liverpool Home Kit 21/22</p>
                            <p class="price">$89.99</p>
                ...
                <div class="box">
                    ...
                    <div class="product-desc">
                        <div class="emri-cmimi">
                            <p class="name">Ajax Third Kit 21/22</p>
                            <p class="price">$89.99</p>
            ...
            <div class="boxes">
                ...
                <div class="box">
                    ...
                    <div class="product-desc">
                        <div class="emri-cmimi">
                            <p class="name">Man City Away Kit 21/22</p>
                            <p class="price">$89.99</p>
                ...
                <div class="box">
                    <img src="images/bay.png">
                    <div class="product-desc">
                        <div class="emri-cmimi">
                            <p class="name">Bayern Munchen Away Kit 21/22</p>
                            <p class="price">$89.99</p>
